  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 overflow-hidden bg-[#080808]/80 backdrop-blur-md border-b border-[#111111]/50">
      <div className="ticker-track py-3">
        {items.map((item, i) => (
          <span key={i} className="flex items-center flex-shrink-0 text-[10px] font-bold tracking-[0.2em] text-[#999999] uppercase whitespace-nowrap">
            {item}
            <div className="mx-4 opacity-50 scale-75">
              <Star />
            </div>
          </span>
        ))}
