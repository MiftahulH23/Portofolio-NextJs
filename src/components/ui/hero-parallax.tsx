...
export const Header = () => {
  ...
  const { personalInfo } = portfolioData; // Ambil personal info dari data

  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      <h1 className="text-2xl md:text-6xl font-bold dark:text-white flex items-baseline flex-wrap">
        <span>Dari Ide Menjadi&nbsp;</span>
        <FlipWords words={words} />
      </h1>
      
      <div className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        <TypeAnimation
          sequence={[subheadlineText, 1000]}
          wrapper="span"
          speed={60}
      ...
      <div className="flex items-center gap-4 mt-8">
        ...
        <div className="flex items-center gap-2">
            ...
            <Button variant="outline" asChild size="icon">
              <Link href={personalInfo.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
