export const portfolioData = {
  personalInfo: {
    ...
    summary:
      "Full-Stack Web Developer dengan spesialisasi pada ekosistem Laravel dan React.js. Berpengalaman dalam merancang, mengembangkan, dan mengoptimalkan aplikasi web yang user-friendly dan scalable, dibuktikan melalui proyek magang di PT Bank Riau Kepri Syariah dan pengembangan sistem informasi kompleks. Antusias untuk berkontribusi dalam pengembangan produk inovatif dan efisien sebagai Web Developer.",
  ...
  skills: {
    ...
    "Tools & Lainnya": ["Git", "Postman", "Manual Testing"],
  },
};
